...
#error "riscv::csr: unknown __riscv_xlen"
        ...
        class write_only_reg {
          public:
            ...
            template<write_datatype_t VALUE>
            ...
            template<write_datatype_t MASK>
            void set_const(void) {
        ...
        template<class C>
        class read_write_reg : public read_only_reg<C>
          ...
          public:
            ...
            datatype_t read_write_const(void) {
                if constexpr ((VALUE & CSR_IMM_OP_MASK) == VALUE) {
...
namespace riscv {
    namespace csr {
        /* Machine ISA */
        template<class OPS>
        class misa_reg : public read_write_reg<OPS> {
        };
        using misa = misa_reg<riscv::csr::misa_ops>;
        /* Machine Vendor ID */
        template<class OPS>
        class mvendorid_reg : public read_only_reg<OPS> {
        };
        using mvendorid = mvendorid_reg<riscv::csr::mvendorid_ops>;
        /* Machine Architecture ID */
        template<class OPS>
        class marchid_reg : public read_only_reg<OPS> {
        };
        using marchid = marchid_reg<riscv::csr::marchid_ops>;
        /* Machine Implementation ID */
        template<class OPS>
        class mimpid_reg : public read_only_reg<OPS> {
        };
        using mimpid = mimpid_reg<riscv::csr::mimpid_ops>;
        /* Hardware Thread ID */
        template<class OPS>
        class mhartid_reg : public read_only_reg<OPS> {
        };
        using mhartid = mhartid_reg<riscv::csr::mhartid_ops>;
        /* Machine Status */
        template<class OPS>
        class mstatus_reg : public read_write_reg<OPS> {
          public:
        ...
        template<class OPS>
        class mstatush_reg : public read_write_reg<OPS> {
        };
        using mstatush = mstatush_reg<riscv::csr::mstatush_ops>;
        /* Machine Trap Vector Base Address */
        template<class OPS>
        class mtvec_reg : public read_write_reg<OPS> {
          public:
        ...
        template<class OPS>
        class medeleg_reg : public read_write_reg<OPS> {
        };
        using medeleg = medeleg_reg<riscv::csr::medeleg_ops>;
        /* Machine Interrupt Delegation */
        template<class OPS>
        class mideleg_reg : public read_write_reg<OPS> {
        };
        using mideleg = mideleg_reg<riscv::csr::mideleg_ops>;
        /* Machine Interrupt Pending */
        template<class OPS>
        class mip_reg : public read_write_reg<OPS> {
          public:
        ...
        template<class OPS>
        class mie_reg : public read_write_reg<OPS> {
          public:
        ...
        template<class OPS>
        class mcountinhibit_reg : public read_write_reg<OPS> {
          public:
        ...
        /* Supervisor Status */
        template<class OPS>
        class sstatus_reg : public read_write_reg<OPS> {
          public:
        ...
        template<class OPS>
        class stvec_reg : public read_write_reg<OPS> {
          public:
        ...
        template<class OPS>
        class sie_reg : public read_write_reg<OPS> {
          public:
        ...
        template<class OPS>
        class ustatus_reg : public read_write_reg<OPS> {
          public:
        ...
        template<class OPS>
        class uip_reg : public read_write_reg<OPS> {
          public:
        ...
        template<class OPS>
        class uie_reg : public read_write_reg<OPS> {
          public:
        ...
        template<class OPS>
        class uscratch_reg : public read_write_reg<OPS> {
        };
        using uscratch = uscratch_reg<riscv::csr::uscratch_ops>;
        /* User Exception Program Counter */
        template<class OPS>
        class uepc_reg : public read_write_reg<OPS> {
        };
        using uepc = uepc_reg<riscv::csr::uepc_ops>;
        /* User Exception Cause */
        template<class OPS>
        class ucause_reg : public read_write_reg<OPS> {
          public:
        ...
        template<class OPS>
        class utvec_reg : public read_write_reg<OPS> {
          public:

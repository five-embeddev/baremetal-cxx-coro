...
env.Replace(
    AR=platform.get_tool_path("gcc-ar"),
    AS=platform.get_tool_path("as"),
    CC=platform.get_tool_path("gcc"),
    GDB=platform.get_tool_path("gdb"),
    CXX=platform.get_tool_path("g++"),
    OBJCOPY=platform.get_tool_path("objcopy"),
